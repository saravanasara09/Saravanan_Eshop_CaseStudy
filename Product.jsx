//Component for product addition and modification
      ...
      switch (field) {
        case "name": {
          if (value.length > 255) {
            ...
            valid = matchRegex(value, "^([A-Za-z0-9\\s]+)$");
        ...
        case "imageUrl": {
          if (value.length > 255) {
            valid = false;
            message = "Image URL can be of length 255 characters";
          } else {
            try {
          ...
          <Grid item xs={4}>
            ...
            >
              <CreatableSelect
                ...
                helperText={
                  formData.category.error && formData.category.errorMessage
                }
                options={categories}
              />
            </div>
            ...
            >
              <TextField
                ...
                onChange={(event) =>
                  saveOnChange("manufacturer", event.target.value)
                }
                onBlur={(event) =>
                  validateAndSave("manufacturer", event.target.value)
                }
                error={formData.manufacturer.error}
                helperText={
                  formData.manufacturer.error &&
                  formData.manufacturer.errorMessage
                }
              />
            </div>
            <div
            ...
            >
              <TextField
                ...
                onChange={(event) =>
                  saveOnChange("availableItems", event.target.value)
                }
                onBlur={(event) =>
                  validateAndSave("availableItems", event.target.value)
                }
                error={formData.availableItems.error}
                helperText={
                  formData.availableItems.error &&
                  formData.availableItems.errorMessage
                }
              />
            </div>
            <div
            ...
            >
              <TextField
                ...
                onChange={(event) =>
                  saveOnChange("imageUrl", event.target.value)
                }
                onBlur={(event) =>
                  validateAndSave("imageUrl", event.target.value)
                }
                error={formData.imageUrl.error}
                helperText={
                  formData.imageUrl.error && formData.imageUrl.errorMessage
                }
              />
            </div>
            <div
            ...
            >
              <TextField
                ...
                onChange={(event) =>
                  saveOnChange("description", event.target.value)
                }
                onBlur={(event) =>
                  validateAndSave("description", event.target.value)
                }
