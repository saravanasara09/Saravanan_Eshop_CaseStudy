...
const PlaceOrder = () => {
  ...
  const initPageData = useCallback(
    (data = json, redirect = navigate, showMessage = broadcastMessage) => {
      if (data === null) {
        ...
        <Grid item xs={12}>
          <div style={{ display: "flex", justifyContent: "center" }}>
            <Stepper activeStep={activeStep} sx={{ width: "80%" }}>
              {stepsForOrdering !== null &&
                stepsForOrdering.length > 0 &&
