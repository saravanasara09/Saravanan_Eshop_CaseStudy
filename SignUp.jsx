    ...
    if (value == null || value.length === 0) {
      ...
      switch (field) {
        case "firstName": {
          if (value.length > 255) {
            valid = false;
            message = "First Name can be maximum of 255 characters";
          } else {
        ...
        case "lastName": {
          if (value.length > 255) {
            valid = false;
            message = "Last Name can be maximum of 255 characters";
          } else {
            valid = matchRegex(value, "^([A-Za-z]+)$");
        ...
        case "email": {
          if (value.length > 255) {
            valid = false;
            message = "Email can be maximum of 255 characters";
          } else {
            valid = matchRegex(
              value,
              "^\\w+([\\.-]?\\w+)*@\\w+([\\.-]?\\w+)*(\\.\\w{2,3})+$"
        ...
        case "password": {
          if (value.length < 6 || 40 < value.length) {
            ...
            message =
              "Password must contain atleast a symbol (!@#$%^&*), an upper case letter, a lower case letter and a number";
          }
          break;
        }
            ...
            <Grid item xs={4}>
              ...
              >
                <TextField
                  ...
                  onChange={(event) =>
                    saveOnChange("firstName", event.target.value)
                  }
                  onBlur={(event) =>
                    validateAndSaveInMemory("firstName", event.target.value)
                  }
                  error={formData.firstName.error}
                  helperText={
                    formData.firstName.error && formData.firstName.errorMessage
                  }
                />
              </div>
              <div
              ...
              >
                <TextField
                  ...
                  onChange={(event) =>
                    saveOnChange("lastName", event.target.value)
                  }
                  onBlur={(event) =>
                    validateAndSaveInMemory("lastName", event.target.value)
                  }
                  error={formData.lastName.error}
                  helperText={
                    formData.lastName.error && formData.lastName.errorMessage
                  }
                />
              </div>
              <div
              ...
              >
                <TextField
                  ...
                  onChange={(event) =>
                    saveOnChange("email", event.target.value)
                  }
                  onBlur={(event) =>
                    validateAndSaveInMemory("email", event.target.value)
                  }
                  error={formData.email.error}
                  helperText={
                    formData.email.error && formData.email.errorMessage
                  }
                />
              </div>
              <div
              ...
              >
                <TextField
                  ...
                  onChange={(event) =>
                    saveOnChange("password", event.target.value)
                  }
                  onBlur={(event) =>
                    validateAndSaveInMemory("password", event.target.value)
                  }
              ...
              >
                <TextField
                  ...
                  onChange={(event) =>
                    saveOnChange("confirmPassword", event.target.value)
                  }
                  onBlur={(event) =>
                    validateAndSaveInMemory(
                      "confirmPassword",
                      event.target.value
                    )
                  }
              ...
              >
                <TextField
                  ...
                  onChange={(event) =>
                    saveOnChange("contactNumber", event.target.value)
                  }
                  onBlur={(event) =>
                    validateAndSaveInMemory("contactNumber", event.target.value)
                  }
                  error={formData.contactNumber.error}
                  helperText={
                    formData.contactNumber.error &&
                    formData.contactNumber.errorMessage
                  }
                />
              </div>
              <div
