// Address Component for creating/selecting address at the time of placing order.
...
const Address = ({ callbackFunction, address }) => {
  ...
  const { loggedInUserId, accessToken, isAccessTokenValid, logout } =
    useContext(AuthCtx);
          ...
          <Grid item xs={4}>
            ...
            >
              <TextField
                ...
                onBlur={(event) =>
                  validateAndSave("contactNumber", event.target.value)
                }
            ...
            >
              <TextField
                ...
                onBlur={(event) =>
                  validateAndSave("street", event.target.value)
                }
                error={formData.street.error}
                helperText={
                  formData.street.error && formData.street.errorMessage
                }
              />
            </div>
            <div
            ...
            >
              <TextField
                ...
                onChange={(event) =>
                  saveOnChange("landmark", event.target.value)
                }
                onBlur={(event) =>
                  validateAndSave("landmark", event.target.value)
                }
                error={formData.landmark.error}
                helperText={
                  formData.landmark.error && formData.landmark.errorMessage
                }
              />
            </div>
            <div
            ...
            >
              <TextField
                ...
                onChange={(event) =>
                  saveOnChange("zipcode", event.target.value)
                }
                onBlur={(event) =>
                  validateAndSave("zipcode", event.target.value)
                }
                error={formData.zipcode.error}
                helperText={
                  formData.zipcode.error && formData.zipcode.errorMessage
                }
              />
            </div>
            <div
